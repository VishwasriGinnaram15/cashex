    ...
    return (
        <>
            <header>
                <nav>
                    <div className="logo">
                    <Link href={"/"}>  <img className="w-auto h-7" src="/images/mainLogo.png" alt="" /></Link>
                    </div>
                    <ul className="desktop pt-3 pb-3">
                        <div className="ul-desktop">
                            <li className="hide active nav-li-a">
                                <i className="active-i nav-i"></i>
                                <Link href={"/"}>  <a className="nav-ul-li-a">Home</a></Link>
                            </li>
                            <Link href={"/aboutus"}><li className="hide nav-li-a"><a className="nav-ul-li-a">About Us</a></li></Link>
                            <Link href={"/merchant"} > <li className="hide nav-li-a"><a className="nav-ul-li-a">Merchants</a></li></Link>
                            <Link href={"/download"}  > <li className="hide nav-li-a"><a className="nav-ul-li-a">Download</a></li></Link>
                            <Link href={"/contactus"}>  <li className="hide nav-li-a"><a className="nav-ul-li-a">Contact Us</a></li></Link>
                        </div>
                    </ul>
                    <svg className="menu" onClick={showSidebar} fill="#381860" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="25px" height="25px"><path d="M 0 7.5 L 0 12.5 L 50 12.5 L 50 7.5 Z M 0 22.5 L 0 27.5 L 50 27.5 L 50 22.5 Z M 0 37.5 L 0 42.5 L 50 42.5 L 50 37.5 Z"/></svg>
                    {sidebarVisible && (
                        <ul className="sidebar" style={{ display: 'flex' }}>
                            <li onClick={hideSidebar}><a href="" className="sidebar-li flex justify-center mt-4">
